...
right) — use these when an OCR glyph is ambiguous:
  ...
  BINIALI/BINIALI, BINIAMAR/BINIAMAR, BINIARAIX/BINIARAIX,
  BINIARROIG/BINIARROY, BINIFOUBELL/BINIFAUVELL,
  BINISALEM/BENISALEM, BUGER/BUGER, BUÑOLA/BUÑOLA, CAIMARI/CAYMARI,
  ...
  FORMENTERA/FORMENTERA, FORNALUTX/FORNALUIG, FORNELLS/FORNELLS
  ...
  SALINAS LAS/LAS SALINAS O SAN JOSEPH, SAN AGUSTIN/SAN AGUSTIN EN PORMAÑY,
  SAN ANTONIO ABAD/SAN ANTONIO EN PORMAÑY,
  SAN CARLOS/SAN CARLOS EN SANTA EULALIA, SAN CLEMENTE/SAN CLEMENTE,
  SAN CRISTOBAL/SAN CHRISTOVAL, SAN JOSE/SAN JOSE EN PORMAÑY,
...
# the column headers (BURCLA → BUÑOLA, ALCANIZ → ALCUDIA, etc.).
PUEBLO_ROSTER = (
    ...
    "BUGER(18) BUÑOLA(19) CAIMARI(20) CALOBRA,LA(21) CALVIA(22) CAMPANET(23) "
    ...
    "FERRERIAS(37) FIGUERA,SA(38) FORMENTERA(39) FORNALUTX(40) FORNELLS(41) "
